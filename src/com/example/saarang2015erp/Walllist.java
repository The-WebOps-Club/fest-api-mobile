...
public class Walllist extends ArrayAdapter<String> {
	...
	private final String[] discription, allComments,username,subject, date, id;
	public static String comment, postId ;

	public Walllist(Activity context, String[] discription, String[] allComments,
			String[] username, String[] subject, String[] date, String[] id) {
	...
	public View getView(final int position, View view, ViewGroup parent) {
		...
		TextView txtDescription = (TextView) rowView.findViewById(R.id.username);
		...
		TextView txtDescription1 = (TextView) rowView.findViewById(R.id.description);
	...
	class postComments extends AsyncTask<String, String, String> {
		...
		protected String doInBackground(String... params) {
			...
			Log.d("Commented what?", Walllist.comment);
			JSONObject json = jsonParser.makeHttpRequest(url, "POST", paramse, "a26fa6831f477a5e5d88dd418714d20cd2f36cd1");
