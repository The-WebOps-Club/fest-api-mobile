...
public class ExpandableListAdapterForSearchResults extends BaseExpandableListAdapter {
    ...
    public ExpandableListAdapterForSearchResults(Context context, List<String> listDataHeader,
